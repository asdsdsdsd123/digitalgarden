---
{"dg-publish":true,"dg-home":null,"permalink":"/02 SAS/02 GTL/项目中的/森林图-forest/","dgPassFrontmatter":true}
---
...
[[03 STAT/项目中的/生存分析/03 生存分析-分层（不分层）Cox模型求风险比HR及其CI\|HR统计方法参考这部分]]
...
[[03 STAT/项目中的/生存分析/05 生存分析-分层CMH计算ORR&DCR差值CI及p\|CMH客观缓解率统计方法参考这部分]]
